from d0.PieSlice.ImperialPieSlice import ImperialPieSlice
...
class PieSliceTest(ScadTestCase):
    """
    Test cases for PieSlice2D.
    """

    # ------------------------------------------------------------------------------------------------------------------
    def testPieSlice4n(self):
        """
        ...
        self.assertTrue(pie_slice.fn4n)
    ...
    # ------------------------------------------------------------------------------------------------------------------
    def testPieSlice3D(self):
        """
        Test a 3D pie slices.
        """
        path_actual, path_expected = self.paths()
        ...
        self.assertAlmostEqual(80.0, pie_slice.end_angle)
        self.assertEqual(1, pie_slice.convexity)
        self.assertIsNone(pie_slice.fn4n)
    ...
    def testImperialMetricPieSlice2D(self):
        ...
        self.assertIsNone(pie_slice.imperial_pie_slice.height)
        ...
        self.assertIsNone(pie_slice.imperial_pie_slice.fn4n)
